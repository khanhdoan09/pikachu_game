...
export default function rightChooseBlocks(blockDeparture, blockDestination) {
        ...
        checkLevel4(blockDeparture, blockDestination)

}

function checkLevel4(blockDeparture, blockDestination) {
    ...
    blockTempDeparture.x = xOfYMin
    blockTempDeparture.y = yMin
    blockTempDestination.x = xOfYMax
    blockTempDestination.y = yMax
